TotalCommander:
    ...
    vim.Comment("<cm_TCFS2Tools_SwitchMenu>","显示/隐藏：TC主菜单栏")
    vim.Comment("<cm_TCFS2Tools_TrackMainMenu>","显示/隐藏：TC主菜单列表")
    vim.Comment("<TC_ShowAndHideWinTitleBar>", "显示/隐藏：窗口标题栏")
    ...
    vim.map("'", "<cm_ShowHint>", "TTOTAL_CMD")
    ...
    vim.map("Vl", "<cm_TCFS2Tools_SwitchMenu>", "TTOTAL_CMD")
	vim.map("Vv", "<cm_TCFS2Tools_TrackMainMenu>", "TTOTAL_CMD")
		
	vim.map("Vj", "<TC_ShowAndHideWinTitleBar>", "TTOTAL_CMD")
...
return
;=====================TCFS2Tools=====================
<cm_TCFS2Tools_SwitchMenu>:
    SendPos(65539)
return
<cm_TCFS2Tools_TrackMainMenu>:
     SendPos(65540)
return
